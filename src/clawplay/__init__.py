...
__all__ = [
    "__version__",
    # scoreboards
    "scores", "LiveScores", "SPORTS",
    "render_report", "write_report", "render_css",
    # match reports
    "MatchReport", "Aggregator", "find_match",
    "render_match_report", "write_match_report", "extract_rich_content",
    # browser client
    "Clawplay", "ClawplayError", "health",
    # design tokens (re-exported so consumers can match the look)
    "ACCENT_BLUE", "ACCENT_BLUE_LIGHT",
    "BG_PAGE", "BG_SURFACE", "BG_SURFACE_RAISED", "BORDER",
    "BRAND_BLUE", "FINAL_GREY",
    "LIVE_GREEN", "LIVE_RED", "SIGNAL_RED",
